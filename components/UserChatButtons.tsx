...
} = findByPropsLazy("toggleSelfMute", "toggleSelfDeaf", "toggleLocalMute", "toggleLocalSoundboardMute", "setDisableLocalVideo");
    ...
    return (
        <VoiceUserButton
            ...
            onClick={() => {
                ...
                openPrivateChannel({ recipientIds: [user.id] } as any); // TODO: fix types
            }}
        />
    );
}
